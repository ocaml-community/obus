...
(* OASIS_START *)
(* DO NOT EDIT (digest: afedbc1f449501cbcef1c007e0dbc041) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               SrcRepo
                 ({
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "https://github.com/diml/obus.git";
                      src_repo_browser = Some "https://github.com/diml/obus";
     ...
     oasis_version = "0.4.2";
     oasis_digest = Some "\242\185A\228J\133\174,\003qt\178`KFS";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
