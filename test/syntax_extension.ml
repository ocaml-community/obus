let x = [: string -> uint -> string -> string -> string -> string list -> (string, variant) assoc -> int -> uint ]
...
let big_tuple =
  [: int * string * uint * int32 * byte * char * int list * int * int * string * variant * signature ]
