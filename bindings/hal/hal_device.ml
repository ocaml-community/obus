...
let op_interface = OBus_proxy.make_interface "org.freedesktop.Hal.Device"
...
module Volume = struct
  let op_interface = OBus_proxy.make_interface "org.freedesktop.Hal.Device.Volume"
  OP_method Mount : string -> string -> string list -> int
  OP_method Unmount : string list -> int
  OP_method Eject : string list -> int
end
module Storage = struct
  let op_interface = OBus_proxy.make_interface "org.freedesktop.Hal.Device.Storage"
  OP_method Eject : string list -> int
  OP_method CloseTray : string list -> int
end
module Storage_removable = struct
  let op_interface = OBus_proxy.make_interface "org.freedesktop.Hal.Device.Storage.Removable"
  OP_method CheckForMedia : bool
end
module Wake_on_lan = struct
  let op_interface = OBus_proxy.make_interface "org.freedesktop.Hal.Device.WakeOnLan"
  OP_method GetSupported : int
  OP_method GetEnabled : int
  OP_method SetEnabled : bool -> int
end
module System_power_management = struct
  let op_interface = OBus_proxy.make_interface "org.freedesktop.Hal.Device.SystemPowerManagement"
...
module Cpufreq = struct
  let op_interface = OBus_proxy.make_interface "org.freedesktop.Hal.Device.CPUFreq"
...
module Laptop_panel = struct
  let op_interface = OBus_proxy.make_interface "org.freedesktop.Hal.Device.LaptopPanel"
  OP_method SetBrightness : int -> int
  OP_method GetBrightness : int
end
module Dock_station = struct
  let op_interface = OBus_proxy.make_interface "org.freedesktop.Hal.Device.DockStation"
  OP_method Undock : int
end
module Kill_switch = struct
  let op_interface = OBus_proxy.make_interface "org.freedesktop.Hal.Device.KillSwitch"
