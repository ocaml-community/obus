...
val device_added : unit -> Hal_device.udi OBus_signal.t
val device_removed : unit -> Hal_device.udi OBus_signal.t
val new_capability : unit -> (Hal_device.udi * string) OBus_signal.t
val global_interface_lock_acquired : unit -> (string * string * int) OBus_signal.t
val global_interface_lock_released : unit -> (string * string * int) OBus_signal.t
