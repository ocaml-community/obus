...
val linux_lvm2_lvremove :
  t -> group_uuid:string -> uuid:string -> options:string list -> unit Lwt.t
...
val linux_lvm2_vgremove_pv :
  t -> vg_uuid:string -> pv_uuid:string -> options:string list -> unit Lwt.t
...
val drive_unset_all_spindown_timeouts :
  t -> cookie:all_spindown_timeouts_cookie -> unit Lwt.t

type inhibit_all_polling_cookie

val drive_inhibit_all_polling :
  t -> options:string list -> inhibit_all_polling_cookie Lwt.t

val drive_uninhibit_all_polling :
  t -> cookie:inhibit_all_polling_cookie -> unit Lwt.t
