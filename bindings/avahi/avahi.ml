...
module Server = struct
  ...
  OBUS_method GetVersionString: unit -> string
  OBUS_method GetAPIVersion: unit -> uint
  OBUS_method GetHostName: unit -> string
  OBUS_method SetHostName: string -> unit
  OBUS_method GetHostNameFqdn: unit -> string
  OBUS_method GetDomainName: unit -> string
  OBUS_method IsNSSSupportAvailable: unit -> bool
  OBUS_method GetState: unit -> int
  OBUS_signal StateChanged : int * string
  OBUS_method GetLocalServiceCookie: unit -> uint
  ...
  OBUS_method EntryGroupNew: unit -> OBus_proxy.t
