...
val return : 'a OBus_context.t -> 'a -> unit Lwt.t
  (** [return ~context args] sends a reply using the given context *)

val fail : 'a OBus_context.t -> exn -> OBus_error.message -> unit Lwt.t
...
val fail_by_name : 'a OBus_context.t -> OBus_error.name -> OBus_error.message -> unit Lwt.t
