...
module Org_freedesktop_DBus : sig
  ...
  type type_start_service_by_name_result =
    [ `Already_running
    | `Success ]
  val make_start_service_by_name_result : int32 -> type_start_service_by_name_result
  val cast_start_service_by_name_result : type_start_service_by_name_result -> int32
